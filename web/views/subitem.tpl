...
<ul class="child_ul clearfix" style="background:{{viewmodle['b_color']}}">
    <li data-id="{{viewmodle['finger_print']}}" node-index="{{viewmodle['node_index']}}" layerno="{{item['layer_no']}}" parentordernos="{{item['parent_order_nos']}}" class="clearfix">
        ...
        <div class="col_4 col_item">{{item['ncount']}}</div>
